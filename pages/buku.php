...
<div id="content">
    <p id="tombol-tambah-container">
        ...
        <a target="_blank" href="ekspor_pdf_buku.php"><img src="pdf.png" height="50px" height="50px"></a>
        <a target="_blank" href="ekspor_excel_buku.php"><img src="excel.png" height="50px" height="50px"></a> 
